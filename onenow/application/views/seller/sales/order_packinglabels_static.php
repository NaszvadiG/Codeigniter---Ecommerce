 ...
 ?>
	...
	<div class="container">
		...
		<div id="print_container">
			<div class="contents">
				<div id="header">
					<p class="footnote text-center">This serves as your order labels. Please print and cut</p>
				</div>
				<div id="boxLabels">
					...
					<canvas class="canvas_boxLabel" data-suite="<?php echo $this->authuser->suite; ?>" data-merchant="<?php echo ($this->authuser->suite == 'BTH-N' || $this->authuser->suite == 'BTH-P') ? $_SESSION['name'] : 'BUYTHAI';?>" data-id="<?php echo ($i+1); ?>" width= "500" height= "333">
