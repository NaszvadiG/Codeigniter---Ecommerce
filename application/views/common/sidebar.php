...
<?php endif; ?>
        ...
        <!--<input type="checkbox" id="popular" disabled="disabled">
        <label for="popular">Most Popular
            <i class="fa fa-plus" aria-hidden="true"></i>
            <i class="fa fa-minus" aria-hidden="true"></i>
        </label>
        <div></div>
        <input type="checkbox" id="print" disabled="disabled">
        <label for="print">Print
            <i class="fa fa-plus" aria-hidden="true"></i>
            <i class="fa fa-minus" aria-hidden="true"></i>
        </label>
        <div></div>
        <input type="checkbox" id="material" disabled="disabled">
        <label for="material">Materials
            <i class="fa fa-plus" aria-hidden="true"></i>
            <i class="fa fa-minus" aria-hidden="true"></i>
        </label>
        <div></div>-->
