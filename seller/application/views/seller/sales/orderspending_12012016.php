...
<div class="container main-container headerOffset">
	...
	<div class="row order-filters">
		<div class="col-xs-4 filter-button-container">
			<div class="row">
				<button class="order-filter" type="button" data-filter_type="all"><?php echo $this->translations->web_seller_all_orders; ?></button>
			</div>
		</div>
		<div class="col-xs-4 filter-button-container">
			<div class="row">
				<button class="order-filter active" type="button" data-filter_type="standard"><?php echo $this->translations->web_seller_standard_orders; ?></button>
			</div>
		</div>
		<div class="col-xs-4 filter-button-container">
			<div class="row">
			...
			<tbody class="product-info-section" <?php echo 'data-order_id='.$orderKey.' '; if ($orderKey != 0){ echo "style=\"border-top: solid 2px black;\""; }?>>
				...
				<tr class="CartProduct one_image" data-item=<?php echo $v['itemsid']?>>
					...
					<td class="show-xs">
						...
						<div class="col-xs-12">
							<div class="row">
								h3 class="col-xs-8 text-left"><?php echo strtoupper($this->translations->web_seller_quantity_ordered); ?>:</h3>h3 class="col-xs-8 text-left"><?php echo strtoupper($this->translations->web_seller_quantity_ordered); ?>:</h3>
							...
							<div class="row">							
								...
								<div class="col-xs-6">
									<div style="margin-top: 20px;">
										<a id="orderconfirm_fulfillBoxes_btn<?php echo $orderKey +1?>" class="btn btn-primary float-right redbtn squarebtn order_submit" data-order="order<?php echo $orderKey +1; ?>"><i class="fa fa-check"></i>Confirm Order</a>
									</div>
								</div>
							</div>
						</div>
	...
	<div class="row order-customized">
		<div class="no-items">
			<img src="<?php echo base_url('onenow/assets/images/noItems_toDisplay.jpg'); ?>" alt="<?php echo ($this->translations->web_seller_coming_soon); ?>">
		</div>
	</div>
	<?php 
		}else{
	 ?>
	<div class="no-items">
		<img src="<?php echo base_url('onenow/assets/images/noItems_toDisplay.jpg'); ?>" alt="<?php echo ($this->translations->web_seller_you_currently_dont_have_any_pending_orders); ?>">
	</div>
	 <?php 
		}
	 ?>
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<div class="col-xs-12 col-sm-4 col-sm-offset-4 popPrintBtnGrp">
		            <button type="button" id="pickupConfirmBtn" class="btn btn-primary onenowBtn newredBtn" onClick='window.location.href="/seller/orders/confirmed_orders"' style="width: 100%;">OK</button>
		        </div>
		    </div>
		</div>
		<!-- /.modal-content -->
