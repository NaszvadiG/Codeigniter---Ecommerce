...
<div class="modal signUpContent fade" id="ModalForget" tabindex="-1" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true"> &times;</button>
				<h3 class="modal-title-site text-center"><?php echo form_label($this->translations->web_seller_forgot_password); ?></h3>
			</div>
			<div class="modal-body">
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<div class="form-group required reg-address">
							<div>
								<?php echo form_label($this->translations->web_seller_address, '' ,array('class'=>'control-label')); ?> 
								<?php echo form_input(array(
										'id' => 'regaddress', 
										'name' => 'regaddress',
