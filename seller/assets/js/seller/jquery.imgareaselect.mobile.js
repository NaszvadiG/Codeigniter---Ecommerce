...
$.imgAreaSelect = function (img, options) {
    ...
    function adjust() {
        ...
        parOfs = position == 'fixed' ?
            ...
            /static|^$/.test($parent.css('position')) ?
                ...
                { left: round($parent.offset().left) - $parent.scrollLeft() + 10,
                    top: round($parent.offset().top) - $parent.scrollTop() + 10 };
    ...
    $box.add($outer).hide().css({ position: position, overflow: 'visible',
        zIndex: zIndex || '0' });
